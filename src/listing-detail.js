  ...
  function MS_ListingDetail(L) {
    ...
    useEffect(() => {
      ...
      requestAnimationFrame(() => {
        var _a;
        return (_a = focusable()[0]) == null ? void 0 : _a.focus();
      });
      return () => {
