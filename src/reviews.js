(function() {
  ...
  const Stars = () => /* @__PURE__ */ React.createElement("span", { className: "ms-rev-stars", "aria-label": "5 stars" }, "\u2605\u2605\u2605\u2605\u2605");
  function MS_ReviewsGallery() {
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "ms-rev-section", id: "reviews" }, /* @__PURE__ */ React.createElement("div", { className: "ms-rev-inner", ref: revRef }, /* @__PURE__ */ React.createElement("h2", { className: "ms-rev-h" }, tx("What Our Travellers Say", "Hva v\xE5re reisende sier", "Ce que disent nos voyageurs", "Was unsere Reisenden sagen")), /* @__PURE__ */ React.createElement("div", { className: "ms-rev-sub" }, /* @__PURE__ */ React.createElement("span", { className: "ms-rev-stars" }, "\u2605"), " 5.0 \xB7 28 ", tx("Google reviews", "Google-anmeldelser", "avis Google", "Google-Bewertungen"), " \xB7 MarrakechStory Tours"), /* @__PURE__ */ React.createElement("div", { className: "ms-rev-grid" }, visibleRev.map((r, i) => /* @__PURE__ */ React.createElement("article", { className: "ms-rev-card", key: i }, /* @__PURE__ */ React.createElement("div", { className: "ms-rev-top" }, /* @__PURE__ */ React.createElement("div", { className: "ms-rev-ava", "aria-hidden": "true" }, initials(r.name)), /* @__PURE__ */ React.createElement("div", { className: "ms-rev-meta" }, /* @__PURE__ */ React.createElement("div", { className: "ms-rev-name" }, r.name), /* @__PURE__ */ React.createElement(Stars, null))), /* @__PURE__ */ React.createElement("p", { className: "ms-rev-text" }, r.text)))), REVIEWS.length > 4 && /* @__PURE__ */ React.createElement("div", { className: "ms-gal-more-row" }, /* @__PURE__ */ React.createElement("button", { className: "ms-gal-more", type: "button", onClick: () => {
      if (showAllRev) {
        setShowAllRev(false);
        setTimeout(() => {
          revRef.current && revRef.current.scrollIntoView({ behavior: "smooth", block: "start" });
        }, 30);
      } else setShowAllRev(true);
    } }, showAllRev ? tx("Show less", "Vis mindre", "Voir moins", "Weniger anzeigen") : tx("Show more", "Vis mer", "Voir plus", "Mehr anzeigen")))), /* @__PURE__ */ React.createElement("div", { className: "ms-gal-inner", id: "gallery", ref: galRef }, /* @__PURE__ */ React.createElement("h2", { className: "ms-rev-h" }, tx("Moments From Our Tours", "\xD8yeblikk fra v\xE5re turer", "Instants de nos circuits", "Momente von unseren Touren")), /* @__PURE__ */ React.createElement("div", { className: "ms-rev-sub ms-gal-sub" }, tx("Real photos from our travellers across Marrakech & beyond", "Ekte bilder fra v\xE5re reisende i Marrakech og videre", "De vraies photos de nos voyageurs \xE0 Marrakech et au-del\xE0", "Echte Fotos unserer Reisenden in Marrakesch und dar\xFCber hinaus")), /* @__PURE__ */ React.createElement("div", { className: "ms-gal-grid" }, visible.map((src, i) => /* @__PURE__ */ React.createElement("a", { className: "ms-gal-item", key: i, href: src, target: "_blank", rel: "noopener", "aria-label": "Tour photo " + (i + 1) }, /* @__PURE__ */ React.createElement("img", { src, loading: "lazy", decoding: "async", alt: "MarrakechStory tour photo " + (i + 1) })))), /* @__PURE__ */ React.createElement("div", { className: "ms-gal-more-row" }, /* @__PURE__ */ React.createElement("button", { className: "ms-gal-more", type: "button", onClick: () => {
      if (showAll) {
        setShowAll(false);
        setTimeout(() => {
          galRef.current && galRef.current.scrollIntoView({ behavior: "smooth", block: "start" });
        }, 30);
