(function() {
  ...
  function windowFor(key, y) {
    switch (key) {
      case "vinterferie":
        return [mk(y, 2, 14), mk(y, 3, 1)];
      case "paske": {
        const e = easter(y);
        return [addDays(e, -9), addDays(e, 1)];
      }
      case "mai":
        return [mk(y, 5, 14), mk(y, 5, 20)];
      case "sommerferie":
        return [mk(y, 6, 28), mk(y, 8, 10)];
      case "hostferie":
        return [mk(y, 9, 27), mk(y, 10, 12)];
      case "jul":
        return [mk(y, 12, 18), mk(y + 1, 1, 2)];
    }
  ...
  function pickSeason(now) {
    ...
    for (const dy of [-1, 0, 1]) {
      ...
      for (const k of ORDER) {
        const w = windowFor(k, y);
        inst.push({ k, s: w[0], e: w[1] });
      }
    }
  ...
  const STD_INC = [
    ["Privat sj\xE5f\xF8r-guide og all transport", "Private driver-guide and all transport"],
    ["Henting og avlevering p\xE5 flyplassen", "Airport pickup & drop-off"],
    ["Frokost hver dag", "Breakfast every day"],
    ["24/7 WhatsApp-st\xF8tte \u2014 Aladdin & Marte", "24/7 WhatsApp support \u2014 Aladdin & Marte"],
  ...
  const SEASONS_META = {
    vinterferie: {
      ...
      en: "Winter break",
      week: "Uke 8\u20139",
      note: P("Vinterferie i 20 varmegrader, langt fra norsk vinter.", "A winter break at 20\xB0C, far from the Norwegian cold.")
    },
    paske: {
      no: "P\xE5ske",
      en: "Easter",
      week: "Palmes\xF8ndag\u20132. p\xE5skedag",
      note: P("P\xE5skeferie med v\xE5rluft og lange, lyse kvelder.", "An Easter break with spring air and long, bright evenings.")
    },
    mai: {
      no: "17. mai-helgen",
      en: "The May long weekend",
      week: "Langhelg i mai",
    ...
    sommerferie: {
      no: "Sommerferie",
      en: "Summer break",
      week: "Fellesferien \xB7 uke 28\u201330",
    ...
    hostferie: {
      ...
      en: "Autumn break",
      week: "Uke 40",
      note: P("H\xF8stferie i Marokkos aller fineste v\xE6r.", "An autumn break in Morocco\u2019s very finest weather.")
    },
    jul: {
      no: "Jul & nytt\xE5r",
      ...
      week: "20. des\u20132. jan",
      priceAdj: 200,
      note: P("Jul og nytt\xE5r i varmen \u2014 med festlig stemning og gallamiddag.", "Christmas and New Year in the warmth \u2014 festive mood and a gala dinner.")
    }
  };
  const VARIANTS = {
    par: {
      tab: P("Par", "Couple"),
      suffix: P("for to", "for two"),
      price: 1090,
      img: "assets/photos/agafay-dinner-table-03.jpg",
      route: "Marrakech \xB7 Agafay",
      ...
      overview: P("Det beste av Marrakech og Agafay for to: to netter i et luksusriad i medinaen, privat hammam, Jardin Majorelle, en soloppgang i luftballong og en siste natt under stjernene i Agafay med kamelritt og middag i \xF8rkenen.", "The best of Marrakech and Agafay for two: two nights in a medina luxury riad, a private hammam, Jardin Majorelle, a sunrise hot-air balloon and a final night under the stars in Agafay with a camel ride and a desert dinner."),
      ...
      tl: [
        ["Ankomst & Marrakech", "Arrival & Marrakech", "Henting ~~ Sj\xE5f\xF8r med navneskilt p\xE5 flyplassen || Innsjekk ~~ Luksusriad i hjertet av medinaen, velkomst med myntete || Kveld ~~ Romantisk middag p\xE5 en takterrasse over den opplyste byen", "Pickup ~~ Driver with a name sign at the airport || Check-in ~~ Luxury riad in the heart of the medina, welcome mint tea || Evening ~~ Romantic dinner on a rooftop above the lit-up city"],
        ["Hammam & Majorelle", "Hammam & Majorelle", "Formiddag ~~ Privat luksushammam: svart s\xE5pe, kessa-skrubb og arganolje-massasje || Ettermiddag ~~ Jardin Majorelle og privat guidet tur i medinaen || Kveld ~~ Middag p\xE5 en restaurant dere velger fra katalogen v\xE5r", "Morning ~~ Private luxury hammam: black soap, kessa scrub and an argan-oil massage || Afternoon ~~ Jardin Majorelle and a private guided medina tour || Evening ~~ Dinner at a restaurant you choose from our catalogue"],
        ["Ballong & Agafay", "Balloon & Agafay", "05:00 ~~ Luftballong ved soloppgang over Atlas og palmelundene, med berberfrokost og flybevis || Ettermiddag ~~ Privat transfer til Agafay, kamelritt eller aktivitet etter eget valg || Kveld ~~ Middag under stjernene, overnatting i et luksuri\xF8st \xF8rkentelt", "05:00 ~~ Sunrise hot-air balloon over the Atlas and palm groves, with a Berber breakfast and a flight certificate || Afternoon ~~ Private transfer to Agafay, a camel ride or an activity of your choice || Evening ~~ Dinner under the stars, overnight in a luxury desert tent"],
        ["Frokost & avreise", "Breakfast & departure", "Morgen ~~ Soloppgang og frokost i \xF8rkenen || Transfer ~~ Privat tur tilbake til Marrakech eller direkte til flyplassen", "Morning ~~ Sunrise and breakfast in the desert || Transfer ~~ Private ride back to Marrakech or straight to the airport"]
      ],
    ...
    venner: {
      tab: P("Venner", "Friends"),
      suffix: P("med venner", "with friends"),
      price: 990,
      img: "assets/photos/agafay-quad-desert-18.jpg",
      route: "Marrakech \xB7 Agafay",
      ...
      tl: [
        ["Ankomst & uteliv", "Arrival & nightlife", "Henting ~~ Transfer til riad i medinaen || Kveld ~~ Takbar og street food p\xE5 Jemaa el-Fna", "Pickup ~~ Transfer to a medina riad || Evening ~~ A rooftop bar and street food on Jemaa el-Fna"],
        ["Hammam & medina", "Hammam & medina", "Formiddag ~~ Hammam og avslapning || Ettermiddag ~~ Jardin Majorelle og guidet medina- og souktur || Kveld ~~ Middag p\xE5 en restaurant dere velger fra katalogen v\xE5r", "Morning ~~ Hammam and downtime || Afternoon ~~ Jardin Majorelle and a guided medina & souk tour || Evening ~~ Dinner at a restaurant you choose from our catalogue"],
        ...
        ["Frokost & avreise", "Breakfast & departure", "Morgen ~~ Frokost i \xF8rkenen || Transfer ~~ Tilbake til Marrakech eller flyplassen", "Morning ~~ Breakfast in the desert || Transfer ~~ Back to Marrakech or the airport"]
      ],
      ...
      exc: [["Quad/buggy i Agafay (~\u20AC40/p)", "Quad/buggy in Agafay (~\u20AC40/p)"], ["Drikke p\xE5 takbar", "Rooftop-bar drinks"]]
    },
    familie: {
      tab: P("Familie", "Family"),
      suffix: P("med familien", "with family"),
      price: 950,
      ...
      tl: [
        ["Ankomst & basseng", "Arrival & pool", "Henting ~~ Navneskilt p\xE5 flyplassen || Innsjekk ~~ Riad med basseng og myntete || Kveld ~~ Familiemiddag p\xE5 en takterrasse", "Pickup ~~ Name sign at the airport || Check-in ~~ Riad with a pool and mint tea || Evening ~~ Family dinner on a rooftop"],
        ["Majorelle & Palmeraie", "Majorelle & Palmeraie", "Formiddag ~~ Jardin Majorelle og familievennlig guidet medinatur || Ettermiddag ~~ Kamelritt i Palmeraien || Kveld ~~ Middag p\xE5 en restaurant dere velger fra katalogen v\xE5r", "Morning ~~ Jardin Majorelle and a family-friendly guided medina tour || Afternoon ~~ Camel ride in the Palmeraie || Evening ~~ Dinner at a restaurant you choose from our catalogue"],
      ...
      exc: [["Barneseng/ekstraseng p\xE5 foresp\xF8rsel", "Cot/extra bed on request"], ["Inngang Jardin Majorelle (~150 MAD)", "Jardin Majorelle entrance (~150 MAD)"]]
    }
  };
  const GALLERIES = {
  ...
  function buildTrip(seasonKey, vk) {
    ...
    return {
      ...
      nights,
      route: V.route,
      priceFromEUR: Math.round((V.price + (S.priceAdj || 0)) / 1.4),
      // ×1.4 display markup
  ...
  function build() {
    ...
    const all = ORDER.map((k) => {
      const inst = [-1, 0, 1].map((dy) => {
        const y = now.getFullYear() + dy;
        const w = windowFor(k, y);
        return { y, s: w[0], e: w[1] };
      });
      const cur = inst.find((x) => now >= x.s && now <= x.e);
