...
const ITINS = [
  // ===== Chapter 01 — 3D2N — Merzouga Sahara Escape =====
  {
    ...
    teaser: { en: "Three days, the Sahara, and the tallest sand dunes in North Africa — the fastest way to reach Erg Chebbi from Marrakech.", no: "Tre dager, Sahara og de høyeste sanddynene i Nord-Afrika — den raskeste veien til Erg Chebbi fra Marrakech.", fr: "Trois jours, le Sahara et les plus hautes dunes de sable d'Afrique du Nord — le chemin le plus rapide vers l'Erg Chebbi depuis Marrakech." },
    overview: { en: "The fastest road to the Sahara from Marrakech. Day 1 crosses the Atlas, passes through the UNESCO kasbah of Aït Ben Haddou, and ends with a camel trek into Erg Chebbi at golden hour. Day 2 is yours entirely — sunrise on the dunes, a free day in the desert, a second sunset, Berber music around the fire. Day 3 returns over the Atlas. Three days. One night under the stars. Worth every kilometre.", no: "Den raskeste veien til Sahara fra Marrakech. Dag 1 krysser Atlas, passerer gjennom UNESCO-kasbah i Aït Ben Haddou og avslutter med kamelritt inn i Erg Chebbi i gylden time. Dag 2 er helt din — soloppgang over dynene, en fri dag i ørkenen, en ny solnedgang, berbermusikk rundt bålet. Dag 3 returnerer over Atlas. Tre dager. Én natt under stjernene. Verdt hver kilometer.", fr: "La route la plus rapide vers le Sahara depuis Marrakech. Le Jour 1 traverse l'Atlas, passe par la kasbah UNESCO d'Aït Ben Haddou et se termine par une randonnée à dos de chameau vers l'Erg Chebbi à l'heure dorée. Le Jour 2 est entièrement à vous — lever de soleil sur les dunes, une journée libre dans le désert, un deuxième coucher de soleil, musique berbère autour du feu. Le Jour 3 rentre via l'Atlas. Trois jours. Une nuit sous les étoiles. Chaque kilomètre en vaut la peine." },
    idealFor: { en: "Sahara bucket-listers, short breaks, add-on to any Marrakech stay", no: "Sahara-drømmere, korte pauser, tillegg til ethvert Marrakech-opphold", fr: "Amateurs de Sahara, courts séjours, complément à tout séjour à Marrakech" },
    highlights: [
      { en: "Tizi n'Tichka pass — 2,260m, highest paved road in Morocco", no: "Tizi n'Tichka-passet — 2 260m, høyeste asfalterte vei i Marokko", fr: "Col du Tizi n'Tichka — 2 260m, plus haute route goudronnée du Maroc" },
      { en: "Aït Ben Haddou UNESCO kasbah (Gladiator · Game of Thrones)", no: "Aït Ben Haddou UNESCO-kasbah (Gladiator · Game of Thrones)", fr: "Kasbah UNESCO d'Aït Ben Haddou (Gladiator · Game of Thrones)" },
      { en: "Camel trek into Erg Chebbi at golden hour — 150m dunes", no: "Kamelritt inn i Erg Chebbi i gylden time — 150m dyner", fr: "Randonnée à dos de chameau vers l'Erg Chebbi à l'heure dorée — dunes de 150m" },
      { en: "Sahara sunrise — dunes turn gold as the Milky Way fades", no: "Sahara-soloppgang — dynene blir gull mens Melkeveien falmer", fr: "Lever de soleil au Sahara — les dunes deviennent dorées tandis que la Voie Lactée s'estompe" },
      { en: "Full free day in the dunes — sandboarding, walks, complete rest", no: "Hel fri dag i dynene — sandboarding, turer, fullstendig hvile", fr: "Journée complète libre dans les dunes — sandboard, promenades, repos total" },
      { en: "Berber music & dinner around the fire at luxury camp", no: "Berbermusikk og middag rundt bålet i luksusleirplass", fr: "Musique berbère & dîner autour du feu au camp de luxe" },
    ],
    itinerary: [
      { day: 1, route: { en: "Marrakech → Atlas → Merzouga", no: "Marrakech → Atlas → Merzouga", fr: "Marrakech → Atlas → Merzouga" }, text: { en: "Early departure at 07:00. Tizi n'Tichka mountain pass (2,260m) — photo stop at the summit. Aït Ben Haddou UNESCO kasbah: guided 1–1.5h walk through the 5-storey earthen towers (Gladiator, Game of Thrones). Lunch in Ouarzazate. Dades Gorges S-bend viewpoint. Arrive Merzouga as the dunes glow orange. Camel trek into Erg Chebbi at golden hour (1h, €30/p). Sunset from the 150m dunes. Gnawa welcome at the luxury camp. Moroccan feast dinner under the stars.", no: "Tidlig avreise kl. 07:00. Tizi n'Tichka fjellpass (2 260m) — fotostopp på toppen. Aït Ben Haddou UNESCO-kasbah: guidet 1–1,5t vandring gjennom 5-etasjers jordtårn (Gladiator, Game of Thrones). Lunsj i Ouarzazate. Dades-kløftene S-sving utsiktspunkt. Ankomst Merzouga mens dynene glir i oransje. Kamelritt inn i Erg Chebbi i gylden time (1t, €30/p). Solnedgang fra de 150m høye dynene. Gnawa-velkomst i luksusleirplassen. Marokkansk festmiddag under stjernene.", fr: "Départ matinal à 07h00. Col du Tizi n'Tichka (2 260m) — arrêt photo au sommet. Kasbah UNESCO d'Aït Ben Haddou : balade guidée de 1–1h30 dans les tours de pisé à 5 étages (Gladiator, Game of Thrones). Déjeuner à Ouarzazate. Belvédère des épingles en S des gorges du Dadès. Arrivée à Merzouga alors que les dunes brillent orange. Randonnée à dos de chameau vers l'Erg Chebbi à l'heure dorée (1h, €30/p). Coucher de soleil depuis les dunes de 150m. Accueil Gnawa au camp de luxe. Festin marocain sous les étoiles." } },
      { day: 2, route: { en: "A Full Day in the Sahara", no: "En hel dag i Sahara", fr: "Une Journée Entière au Sahara" }, text: { en: "Sahara sunrise at 06:00 — step outside your tent as the dunes turn gold and the Milky Way fades. Berber breakfast at camp. Full free day: sandboarding, dune walks, optional Bedouin family visit (seasonal), jeep excursion into the black desert, or complete rest at the pool. Second sunset from the top of the dunes. Final desert dinner — Berber music, fire.", no: "Sahara-soloppgang kl. 06:00 — tritt ut av teltet ditt mens dynene blir gull og Melkeveien falmer. Berberfrokost i leiren. Full fri dag: sandboarding, dyneturer, valgfritt Beduin-familiebesøk (sesong), jeeptur inn i den svarte ørkenen, eller fullstendig hvile ved bassenget. Andre solnedgang fra toppen av dynene. Siste ørkensmiddag — berbermusikk, bål.", fr: "Lever de soleil au Sahara à 06h00 — sortez de votre tente tandis que les dunes deviennent dorées et que la Voie Lactée s'estompe. Petit-déjeuner berbère au camp. Journée entière libre : sandboard, promenades dans les dunes, visite optionnelle d'une famille bédouine (saisonnière), excursion en jeep dans le désert noir, ou repos total à la piscine. Deuxième coucher de soleil depuis le sommet des dunes. Dernier dîner dans le désert — musique berbère, feu." } },
  ...
  // ===== 4D3N — Marrakech & Agafay Luxury Escape =====
  {
    ...
    priceFromEUR: 750,
    img: "assets/photos/balloon-marrakech-01.jpg",
    ...
    itinerary: [
      { day: 1, route: { en: "Arrival in Marrakech", no: "Ankomst i Marrakech", fr: "Arrivée à Marrakech" }, text: { en: "Private driver meets you at arrivals with a personalised Marrakech Story sign. Transfer to your luxury riad in the Medina (8 km, 15–20 min). Welcome ceremony: fresh mint tea and Moroccan pastries in the courtyard. Rooftop sunset — the Koutoubia Mosque minaret framed in last light. Optional evening stroll to Jemaa el-Fna. Dinner at leisure.", no: "Privat sjåfør møter deg i ankomsthallen med et personlig Marrakech Story-skilt. Transfer til luksuriøst riad i Medina (8 km, 15–20 min). Velkomstseremoni: fersk myntete og marokkanske kjeks i gårdhagen. Solnedgang fra taket — Koutoubia-moskeens minaret i siste lys. Valgfri kveldstur til Jemaa el-Fna. Middag etter eget valg.", fr: "Un chauffeur privé vous accueille à l'arrivée avec une pancarte Marrakech Story personnalisée. Transfert vers votre riad de luxe dans la Médina (8 km, 15–20 min). Cérémonie d'accueil : thé à la menthe frais et pâtisseries marocaines dans le patio. Coucher de soleil sur le toit — le minaret de la Koutoubia encadré dans les derniers rayons. Balade en option vers Jemaa el-Fna. Dîner à votre convenance." } },
      { day: 2, route: { en: "Hammam & Medina", no: "Hammam & Medina", fr: "Hammam & Médina" }, text: { en: "Traditional Moroccan breakfast on the riad rooftop. Full luxury hammam (2.5–3h): steam room, black soap (savon beldi), kessa exfoliation, ghassoul clay mask, argan oil massage. Lunch at leisure. Private certified guide — 4-hour medina tour: Jemaa el-Fna, Koutoubia gardens, Bahia Palace, souk circuit (spice, carpet, tanneries, lantern quarter), hidden artisan alleys.", no: "Tradisjonell marokkansk frokost på riad-taket. Fullt luksuriøst hammam (2,5–3t): dampbad, svart såpe (savon beldi), kessa-eksfoliering, ghassoul-leirmaske, arganolje-massasje. Lunsj etter eget valg. Privat sertifisert guide — 4-timers medina-omvisning: Jemaa el-Fna, Koutoubia-hager, Bahia-palasset, souk-krets (krydder, teppe, garveri, lyktekvartal), skjulte håndverkersmug.", fr: "Petit-déjeuner marocain traditionnel sur le toit du riad. Hammam de luxe complet (2h30–3h) : bain de vapeur, savon noir (savon beldi), exfoliation kessa, masque à l'argile ghassoul, massage à l'huile d'argan. Déjeuner à votre convenance. Guide certifié privé — visite de 4h de la médina : Jemaa el-Fna, jardins de la Koutoubia, Palais Bahia, circuit des souks (épices, tapis, tanneries, quartier des lanternes), ruelles artisanales cachées." } },
      { day: 3, route: { en: "Sunrise Balloon + Agafay", no: "Soloppgangsballong + Agafay", fr: "Montgolfière au lever du soleil + Agafay" }, text: { en: "Pre-dawn pickup at 05:00. Balloon flight at sunrise — 45–60 minutes above the Palmeraie, Marrakech, the High Atlas peaks, and the start of the Agafay desert. Traditional Berber breakfast and flight certificate on landing. Free morning. Afternoon transfer to the Agafay luxury desert camp (35 km, 45 min). Pool with the Atlas as backdrop. Optional camel ride (€30/p), quad (€40/p), or horse riding (€49/p). Sunset. Moroccan feast dinner under the open sky. Live Gnawa music, oriental dancer, fire performance.", no: "Henting ved daggry kl. 05:00. Ballongtur ved soloppgang — 45–60 minutter over Palmeraie, Marrakech, de høye Atlas-toppene og begynnelsen av Agafay-ørkenen. Tradisjonell berberfrokost og flybevis ved landing. Fri formiddag. Ettermiddagstransfer til Agafay luksusørkenleir (35 km, 45 min). Basseng med Atlas i bakgrunnen. Valgfritt: kamelritt (€30/p), quad (€40/p) eller ridning (€49/p). Solnedgang. Marokkansk festmiddag under åpen himmel. Levende Gnawa-musikk, orientalsk danser, ildshow.", fr: "Départ avant l'aube à 05h00. Vol en montgolfière au lever du soleil — 45–60 minutes au-dessus de la Palmeraie, Marrakech, les sommets du Haut Atlas et les débuts du désert de l'Agafay. Petit-déjeuner berbère traditionnel et certificat de vol à l'atterrissage. Matinée libre. Transfert l'après-midi vers le camp de luxe de l'Agafay (35 km, 45 min). Piscine avec l'Atlas en toile de fond. Balade à dos de chameau en option (€30/p), quad (€40/p) ou équitation (€49/p). Coucher de soleil. Festin marocain sous le ciel ouvert. Musique Gnawa en direct, danseuse orientale, spectacle de feu." } },
      { day: 4, route: { en: "Desert Sunrise & Departure", no: "Ørkensoloppgang & Avreise", fr: "Lever de soleil dans le désert & Départ" }, text: { en: "Optional sunrise walk before breakfast. Full Moroccan breakfast on your private terrace or in the dining tent. Private transfer to Marrakech Menara Airport (40 km, 45–50 min). Driver monitors flight status via WhatsApp.", no: "Valgfri soloppgangstur før frokost. Full marokkansk frokost på din private terrasse eller i spiseteltet. Privat transfer til Marrakech Menara lufthavn (40 km, 45–50 min). Sjåfør overvåker flystatus via WhatsApp.", fr: "Promenade optionnelle au lever du soleil avant le petit-déjeuner. Petit-déjeuner marocain complet sur votre terrasse privée ou dans la tente-restaurant. Transfert privé vers l'aéroport Marrakech Menara (40 km, 45–50 min). Le chauffeur surveille l'état du vol via WhatsApp." } },
    ],
    included: [
  ...
  // ===== 5D4N — Best of Marrakech =====
  {
    ...
    itinerary: [
      { day: 1, route: { en: "Arrival in Marrakech", no: "Ankomst i Marrakech", fr: "Arrivée à Marrakech" }, text: { en: "Private driver meets you at Marrakech Menara Airport with a personalised sign. Transfer to your luxury riad in the Medina (8 km, 15–20 min). Welcome mint tea and Moroccan pastries. Rooftop sunset. Restaurant recommendation and reservation assistance.", no: "Privat sjåfør møter deg på Marrakech Menara lufthavn med et personlig skilt. Transfer til luksuriøst riad i Medina (8 km, 15–20 min). Velkomst myntete og marokkanske kjeks. Solnedgang fra taket. Restaurantanbefaling og reservasjonshjelp.", fr: "Un chauffeur privé vous accueille à l'aéroport Marrakech Menara avec une pancarte personnalisée. Transfert vers votre riad de luxe dans la Médina (8 km, 15–20 min). Thé à la menthe de bienvenue et pâtisseries marocaines. Coucher de soleil sur le toit. Recommandation et aide à la réservation de restaurant." } },
      { day: 2, route: { en: "Medina & Cooking Class", no: "Medina & Matkurs", fr: "Médina & Cours de Cuisine" }, text: { en: "Breakfast in the riad courtyard. Certified guide — 3-hour medina tour: Jemaa el-Fna, Koutoubia gardens, Bahia Palace, souk circuit (spice souk, Berber carpets, leather tanneries, lantern souk). Market visit for cooking class ingredients. Moroccan cooking class in a traditional riad kitchen (€49/p): tagine, couscous, or pastilla with a professional chef — eat what you cook. Free afternoon: riad pool, optional hammam or Majorelle Garden.", no: "Frokost i riad-gårdhagen. Sertifisert guide — 3-timers medina-omvisning: Jemaa el-Fna, Koutoubia-hager, Bahia-palasset, souk-krets (kryddersouk, berberteppe, lærgarveriene, lyktsouk). Markedsbesøk for matkurs-ingredienser. Marokkansk matkurs på et tradisjonelt riad-kjøkken (€49/p): tagine, couscous eller pastilla med en profesjonell kokk — spis det du lager. Fri ettermiddag: riad-basseng, valgfritt hammam eller Majorelle-hagen.", fr: "Petit-déjeuner dans le patio du riad. Guide certifié — visite de 3h de la médina : Jemaa el-Fna, jardins de la Koutoubia, Palais Bahia, circuit des souks (souk aux épices, tapis berbères, tanneries de cuir, souk des lanternes). Visite du marché pour les ingrédients du cours de cuisine. Cours de cuisine marocaine dans une cuisine de riad traditionnel (€49/p) : tajine, couscous ou pastilla avec un chef professionnel — mangez ce que vous cuisinez. Après-midi libre : piscine du riad, hammam en option ou Jardin Majorelle." } },
      { day: 3, route: { en: "Choose Your Morocco — Nature Day", no: "Velg ditt Marokko — Naturdag", fr: "Choisissez Votre Maroc — Journée Nature" }, text: { en: "Full-day private excursion into the landscape surrounding Marrakech. Option A — Ourika Valley & Atlas Mountains (€120/p): Berber villages, riverside Berber restaurant lunch, optional waterfall walk. Option B — Three Atlas Valleys & Kik Plateau (€150/p): panoramic High Atlas views, Berber family home lunch. Option C — Essaouira Atlantic coast (€150/p): argan forest, goats in the trees, UNESCO walled city, fresh seafood lunch at the fishing harbour. All options include private driver for the full day.", no: "Heldags privat utflukt ut i landskapet rundt Marrakech. Alternativ A — Ourika-dalen og Atlasfjellene (€120/p): Berberlandsbyer, elvesiderestaurant lunsj, valgfri fossetur. Alternativ B — Tre Atlas-daler og Kik-plateauet (€150/p): panoramautsikt over Høyatlas, lunsj i berberfamiliens hjem. Alternativ C — Essaouira-atlanterhavskysten (€150/p): arganskog, geiter i trærne, UNESCO-hegnet by, fersk sjømatlunsj ved fiskehavnen. Alle alternativer inkluderer privat sjåfør hele dagen.", fr: "Excursion privée d'une journée dans le paysage entourant Marrakech. Option A — Vallée de l'Ourika et Montagnes de l'Atlas (€120/p) : villages berbères, déjeuner dans un restaurant au bord de la rivière, marche en option jusqu'à la cascade. Option B — Trois vallées de l'Atlas et Plateau du Kik (€150/p) : vues panoramiques sur le Haut Atlas, déjeuner dans une maison familiale berbère. Option C — Côte atlantique d'Essaouira (€150/p) : forêt d'arganiers, chèvres dans les arbres, ville fortifiée UNESCO, déjeuner de fruits de mer frais au port de pêche. Toutes les options incluent un chauffeur privé pour la journée entière." } },
      { day: 4, route: { en: "Agafay Desert", no: "Agafay-ørkenen", fr: "Désert de l'Agafay" }, text: { en: "Checkout after breakfast. Private transfer to the Agafay stone desert (35 km, 45 min). Welcome drink. Pool with the Atlas as backdrop. Optional: camel ride at sunset (€30/p), quad biking (€40/p), buggy (€100/p), horse riding (€49/p). Sunset over the pale stone landscape. Moroccan feast dinner under the open sky. Live Gnawa music, oriental dancer, fire performance. Luxury tent with private bathroom, terrace, heating and air conditioning.", no: "Utsjekk etter frokost. Privat transfer til Agafay-steinørkenen (35 km, 45 min). Velkomstdrink. Basseng med Atlas i bakgrunnen. Valgfritt: kamelritt ved solnedgang (€30/p), quadkjøring (€40/p), buggy (€100/p), ridning (€49/p). Solnedgang over det bleke steinlandskapet. Marokkansk festmiddag under åpen himmel. Levende Gnawa-musikk, orientalsk danser, ildshow. Luksuriøst telt med eget bad, terrasse, oppvarming og air condition.", fr: "Check-out après le petit-déjeuner. Transfert privé vers le désert de pierres de l'Agafay (35 km, 45 min). Boisson de bienvenue. Piscine avec l'Atlas en toile de fond. En option : balade à dos de chameau au coucher du soleil (€30/p), quad (€40/p), buggy (€100/p), équitation (€49/p). Coucher de soleil sur le paysage de pierres pâles. Festin marocain sous le ciel ouvert. Musique Gnawa en direct, danseuse orientale, spectacle de feu. Tente de luxe avec salle de bain privée, terrasse, chauffage et climatisation." } },
      { day: 5, route: { en: "Camp Sunrise & Departure", no: "Leirsoloppgang & Avreise", fr: "Lever de Soleil au Camp & Départ" }, text: { en: "Optional sunrise walk in the desert. Full Moroccan breakfast at the camp. Private transfer to Marrakech Menara Airport (40 km, 45–50 min). Driver monitors flight via WhatsApp.", no: "Valgfri soloppgangstur i ørkenen. Full marokkansk frokost i leiren. Privat transfer til Marrakech Menara lufthavn (40 km, 45–50 min). Sjåfør overvåker fly via WhatsApp.", fr: "Promenade optionnelle au lever du soleil dans le désert. Petit-déjeuner marocain complet au camp. Transfert privé vers l'aéroport Marrakech Menara (40 km, 45–50 min). Le chauffeur surveille le vol via WhatsApp." } },
    ],
    included: [
      { en: "Airport transfers with personalised name sign", no: "Flyplasstransfer med personlig navneskilt", fr: "Transferts aéroport avec pancarte personnalisée" },
      { en: "Private transport throughout", no: "Privat transport gjennom hele reisen", fr: "Transport privé tout au long du séjour" },
  ...
  // ===== 7D6N — Morocco Highlights =====
  {
    ...
    priceFromEUR: 1400,
    img: "assets/photos/sahara-camel-caravan-01.jpg",
  ...
  // ===== 14D13N — Full Morocco Honeymoon =====
  {
    ...
    priceFromEUR: 3200,
    img: "assets/photos/riad-pool-dusk-01.jpg",
