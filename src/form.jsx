                ...
                <div className="form-nav">
                  ...
                  {step < steps.length - 1 ? (
                    ...
                    <div style={{ display: 'flex', gap: 8 }}>
                      ...
                      {!window.MS_Auth_User && (
                        <button className="btn btn-outline" onClick={sendAndRegister}
                          disabled={!data.name.trim() || !data.email.trim()}
                          title={ctx.lang === 'no' ? 'Send og opprett konto' : ctx.lang === 'fr' ? 'Envoyer et créer un compte' : 'Send and create account'}>
