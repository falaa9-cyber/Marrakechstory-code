...
const CURR_EMOJI = { NOK: "\u{1F1F3}\u{1F1F4}", SEK: "\u{1F1F8}\u{1F1EA}", EUR: "\u{1F1EA}\u{1F1FA}", USD: "\u{1F1FA}\u{1F1F8}", MAD: "\u{1F1F2}\u{1F1E6}", GBP: "\u{1F1EC}\u{1F1E7}" };
const CURR_SYMBOL = { NOK: "kr", SEK: "kr", DKK: "kr.", EUR: "\u20AC", USD: "$", MAD: "\u062F.\u0645", GBP: "\xA3" };
...
function LangCurrPill({ lang, curr, langItem, LANG_LIST, CURR_LIST, setLang, setCurr, langHead, currHead }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "ms-lc", ref, style: { position: "relative" } }, /* @__PURE__ */ React.createElement("button", { className: "ms-lc-pill", onClick: () => setOpen((o) => !o), "aria-haspopup": "listbox", "aria-expanded": open, "aria-label": `${lang} / ${curr}` }, /* @__PURE__ */ React.createElement("span", { className: "ms-lc-flag" }, langItem == null ? void 0 : langItem.flag)), open && /* @__PURE__ */ React.createElement("div", { className: "ms-lc-menu ms-lc-menu-lang", role: "listbox" }, /* @__PURE__ */ React.createElement("div", { className: "ms-lc-col-head" }, langHead), /* @__PURE__ */ React.createElement("div", { className: "ms-lc-lang-col" }, LANG_LIST.map((it) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: it.id,
    ...
    /* @__PURE__ */ React.createElement("span", { className: "ms-lc-lang-cur" }, NAV_LANG_TO_CURR[it.id] || ""),
...
function MobileTabBar() {
  ...
  const items = [
    ...
    { key: "search", label: tx("Search", "S\xF8k", "Recherche", "S\xF6k"), icon: ICON.search, go: () => window.dispatchEvent(new CustomEvent("ms:open-cat", { detail: { cat: "activities" } })) },
